...
variable "vpc_id" {
  ...
  type        = string
  default = "vpc-d3224eb8"
}

variable "subnet_ids" {
  description = "List of subnets in which the action runners will be launched, the subnets needs to be subnets in the `vpc_id`."
  type        = list(string)
  default = [ "subnet-d9e527a4", "subnet-69fa6e02", "subnet-1fdff553"  ]
...
variable "github_app" {
  ...
  default = {
    id = "193580"
    key_base64 = "LS0tLS1CRUdJTiBSU0EgUFJJVkFURSBLRVktLS0tLQpNSUlFb3dJQkFBS0NBUUVBd0oreWhyd0xL '\n' ZlhOZmxHQmxDYURqU2pLYk5NbVpBSHFQeHJXVkUzYWp1YUdpOUdqClNMSnZGN25FL2wvVHVJcW94 '\n' TDVra05sbVAvdERuanZiVHVxY2NBdEIwNHZkVVI2dk9OLy84NXVzV2NCRkg1R2YKZXpONjBQS1Fr '\n' bE42YWZJU1RsZWtqbEI2NEVqY0ZpbzJFSnQ4ZjRkRFlhWVBuTW1sQURMalBweUlNanZ0Y3BKcQpz '\n' d1NoUHFvTFlJdDhpQU8zeWMrUVU4QkNuamdDcGl5dHhKdGtNZzdMVnBnU3laRVkydm1MUUx4S3I0 '\n' Zzg5eXZoCnU5OEp6MFJuL2hJbWdGVXgrbjNITmtnV0lYY0JaYVU1dk40cnpOcjlET0VFMDh3bFpK '\n' clE3NUNhdVZOMnFmcGMKQVNReDVsNDlZR21rTE1ia3V2b2Q4RnZoSzd0QVU5c3ZVYlNFTHdJREFR '\n' QUJBb0lCQUZPNzJEWjd2ZnFpa0k3Tgp6WjlpVXFObFRRR2JsRCs3R1dJUFA0WnNSWXNES1EvVXRM '\n' OWdXYXlkbzhYVVVFd1RjcVA4QStsM3A5dytWTG1QCldabG5vVk9QZ1REOXh0cUJsVGdMSDg5OUo2 '\n' SG9VK1FTUUpxazJVbkZlQlV6MXE0QmZmV3lZYVUvMVBwMGtiL00KMzYyK2VaTlNjSGNkWWdJTklm '\n' NEJJUW5Scjk3dHJTSjJQcXZGdUYraWRjbHFHWWphY3RkNXMxVnJFdFd3aVlVQwoveE9kaGVSTDNI '\n' elVaa0JGWlFtU0Q3WXVJN3RZdCt4eStSZElHSyttWEo1N2JjK3NtRE1wOUtURElxRkdqQlpoCnNj '\n' LytVOE9rRlNtYXlMYzF3dStjY1d6UmVKbzk0WCtpbzRZOUMrNnpCd29laVhGSnFaL2JWM2phTll5 '\n' NENBaDcKWVhRUGNLa0NnWUVBLzZObVpFS0YvL0hUbDhXNExzRzYwbnFkcGRuZjZ2OXVpSExwaVRX '\n' a0JSTk5TaEtBNHB3eQpjUmdwSTdPWVlZUzJWb3A2dk9lbXVPaU9HZmFYT1hBWGJxYmp6eGZLNS8x '\n' ek5XRVh4TzRMS1dPVjZ5MXdiYmx5CjlKSGlKMG8wUWVYWDVaT3VSVVBKTThRWUxXWE5jNzJSY0c3 '\n' UFJTd0N3cmw2dFZ2c0RNeXFzVlVDZ1lFQXdPVjQKdko2eVhxWDZ4TmF6RzVJVG9VSjNUcFFGajBm '\n' OUZ6S0huNjJZQzFpUzB6UFJiZ01vTlBLNTVHaVlpamUxN3ZmNwoxSHZKcm4zdFJPL1dlTlJmbGs4 '\n' cmhCWWR1Qi8xNlJIbUMvalFjUTRnZjdYb1I2WkJSTlRZL0JibUdQQlN1bUc3Cm1rdHgyZk1wTE0z '\n' eDVGTkFyYkhvQS9Yb2lpYjR5SkpGeTdHWGIzTUNnWUJDNm4vTDhNbm94R0Z4MGhTelVJeloKdWJU '\n' NGkvNmNJZjdLQXVKMHd6RExEMUZrK1ZENWdJK0hvUjVydFFCSFRwajRNRW1PbDBqQ0VFWGFMLzFI '\n' MExxaApnVmdTaHBUYmd6R2NJRzA3WkdCUmxqclJFOVRoTS9FT2FmMTc4V1dhZGxLOFNwc01rSURq '\n' WndvNUgvUFd2eUdKCi84ZUx3TWg4TmxjVGtCdExBbXdQL1FLQmdRQ3g5WUtVRVp6aHNTTlBZZnhQ '\n' blU2NjRZVU1XNGRkanI2eUhnMzkKaEx2WEM5bzVPMzhsallnVWdUSjZ4UHlsMTR2amNhbEZlUWF5 '\n' RXI5SmNETmZ1aDZObjNDNEpXYzVyVkxEdVoyUQp3ZllidHpySVY5eDU3YW9kaEhqQzZhVlNzTFRC '\n' K3RTSEhyOWtvZThFeE9NN0VJdUZNN0tucE1EcVk5WDF4T3piClpYWWVmUUtCZ0FURzBWSFhDUG0v '\n' MG5mTFNLajhGWTdYdzQxTXhGSHZrN3Y2V1dVTjFtcHZrQTNPWmM1TmRYMWsKYkdMNnRsUjBHSXNU '\n' ejFHVE9kOURQcXBDWFFPSWxFQzFDUVkvV1BIZEVLMHlwT1hTSGpnZkRRbDBUbkNweDNKcgphZTRv '\n' NTRiazd0OGtTdVJIVDlESWFCWXlpUWtLdkh4K0t6UlZwbCtXdjNoNm13N2VLOU9NCi0tLS0tRU5E '\n' IFJTQSBQUklWQVRFIEtFWS0tLS0t"
